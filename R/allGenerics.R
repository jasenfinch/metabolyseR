...
setGeneric('plotSupervisedRF',function(analysis, cls = 'class', label = NULL, ellipses = T, seed = 1234, title = 'MDS plot of a supervised random forest', legendPosition = 'bottom', ...){
