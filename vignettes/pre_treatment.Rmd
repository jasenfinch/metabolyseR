...
param <- analysisParameters('pre-treatment')
```

```{r}
parameters(param,'pre-treatment') <- preTreatmentParameters(
  list(
    keep = 'classes',
...
```{r}
changeParameter(param,'cls') <- 'day'
changeParameter(param,'classes') <- c('H','1','2')
```
