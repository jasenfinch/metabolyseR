...
Features where the maximum proportion of non-missing data per class above two-thirds are retained.
...
An infection progression can clearly be seen from the least to most infected time points.
